...
r_pkgs = c(
  ...
  "tidyfinance", "tidymodels", "tidyquant", "ggtext", "riingo", "ggdist", 
  ...
  "mirai", "nanonext", 
  "targets", "gittargets", "crew", "autometric", "tarchetypes",
...
gh_pkgs <- rlang::list2(
  ...
  list(
    ...
    commit = "cfe17e3f988be40453a31432876d3a9cb404c8be"),
  list(
    ...
    commit = "692db86d23d1ff9d19d32802588b91c294d01c10"),
...
# ~/.gemini/ or ./.env GEMINI_API_KEY=AIzaSyCufvBt9YyqVtTLK2jSWQAdq26Ze3iCrRk
...
rix(
  date = c(latest, "2025-11-03", "2025-11-01", "2025-08-18")[1], 
